...
import { type TimelineElement, TimelineLayout } from "@/components/ui/timeline";

const experiences: TimelineElement[] = [
  {
    id: 1,
...
const ExperienceTimeline = () => {
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <TimelineLayout items={experiences} size="lg" animate />
    </section>
  );
};
